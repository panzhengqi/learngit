...
void can_recv_manager::process_icm_state1_msg(__u8 *msg)
{
    ...
    if(p_icm_state_1->icm_Obstacle_Type > ICM_OBSTACLE_TYPE_NULL){
...
//        p_algorithm_paras->p_obstacle_para.Obstacle_distance   = p_icm_state_1->icm_Obstacle_distance;
//        p_algorithm_paras->p_obstacle_para.Obstacle_speed      = p_icm_state_1->icm_Obstacle_speed;
//        p_algorithm_paras->p_obstacle_para.Obstacle_TTC        = p_icm_state_1->icm_Obstacle_TTC ;
//        p_algorithm_paras->p_obstacle_para.WC_brake_feedback   = p_icm_state_1->icm_WC_brake_feedback;
...
void can_recv_manager::process_icm_state2_msg(__u8 *msg)
{
    ...
    if(p_icm_state_2->icm_Current_speed){
        ...
        p_algorithm_paras->p_control_para.Current_speed       = p_icm_state_2->icm_Current_speed;
        p_algorithm_paras->p_control_para.Real_throttle_fb    = p_icm_state_2->icm_Real_throttle_fb ;
        emit send_algorithm_paras(p_algorithm_paras);
    }
}
...
void can_recv_manager::process_icm_state3_msg(__u8 *msg)
{
    ...
    if(p_icm_state_3->icm_Dynamical_fuel_consumption){
...
void can_recv_manager::process_mcu_control_msg(__u8 *msg)
{
    ...
    if(p_mcu_control_info->mcu_WC_throttle_percent || p_mcu_control_info->mcu_WC_brake_percent){
