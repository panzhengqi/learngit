...
#define ICM_OBSTACLE_TYPE_OTHER        2
...
#define ICM_SPEED_RESO_1KMH            1          // 1Km/h/bit
...
#define OBU_RTK_HEADING_ANGLE_RESO_0_1 0.1             // 0.1 degree/bit
...
typedef struct icm_state_2{
    ...
    unsigned char  icm_Current_speed;
    unsigned char  icm_Real_throttle_fb;
    unsigned char  icm_reserved;
}icm_state_2;
